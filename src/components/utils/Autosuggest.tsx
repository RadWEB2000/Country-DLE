...
export default function Autosuggest({ data, onSelect }: Props) {
    ...
    return (
        <div className="relative w-full" ref={containerRef} >
            <input value={query} onChange={(e) => { setQuery(e.target.value); setShow(true) }} placeholder="Wpisz państwo" type="text" className="capitalize w-full rounded-md border border-stone-300 text-slate-50 text-sm p-2 outline-none focus:ring focus:ring-stone-400" />
            {
